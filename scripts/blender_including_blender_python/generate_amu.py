...
# Version: 1.0
# Authorship: Antigravity by Google Deepmind, Gemini by Google Deepmind
# Original suggestion for using prompt by Google AI powered search
# Prompt generated by: Adeel Khan (@genidma on github)
