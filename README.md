...
For this purpose, participants can:
1. Follow the **[Contributing Guidelines](CONTRIBUTING.md)**.
2. Create an issue in the repository.
3. Provide instructions as bullet points, with one instruction per bullet and a maximum of 20 words per bullet.
4. usage of graphs generated by mermaid js is encouraged, in order to highlight the changes that the user is recommending
5. all feedback is public, so please do not share any sensitive information
